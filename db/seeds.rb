if Unit.none?
  ...
  Unit.create(name: 'gram', factor: 1.0, base_id: nil, short_name: 'g').save!
  Unit.create(name: 'gallon', dimensions: 3, factor: 3.78541178, base_id: Unit.liter.id, short_name: 'gal').save!
  Unit.create(name: 'barrel', dimensions: 3, factor: 225.0, base_id: Unit.liter.id, short_name: 'BBL').save!
  Unit.create(name: 'milliliter', factor: 0.001, base_id: Unit.liter.id, short_name: 'ml').save!
  Unit.create(name: 'milligram', factor: 0.001, base_id: Unit.gram.id, short_name: 'mg').save!
